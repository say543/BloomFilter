Bloom filter module
	...
	notations
		...
		space(MB) : bit array size in megabyte 
		array_size : bit array size in bits
	...
	Bloomfilter.py
		...
		This module is not a thread-safety bloomfilter. in Bloomfilter_test, there is an routine with lock to do multiprocess read/write test and this is the wrapper behavior to support it
		...
		Another option to provide  items_count and ratio for configuration is not supported.
	...
	Bloomfilter_test.py
		...
		====================================================================================
			...
			false_positive: 0.1              array_size: 47925291.88683719
		...
		===============================================================================================================
			...
			it outputs result by 
			false_positive:0.1                 array_size: 95238095.23809524                 hash_count: 1                 ratio: 9.52e+00                 space(MB): 11.353266
			false_positive:0.1                 array_size: 54610823.798325725                 hash_count: 2                 ratio: 5.46e+00                 space(MB): 6.510118
			...
		...
		===============================================================================================================
			...
			false_positive:0.01             hash_count: 3             array_size: 2129981             space(MB): 0.253914
			word_list size: 338882
			iteration: 30
			input test size: 10000
			adjusted test size: 10000
